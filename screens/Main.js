      ...
      <View style={styles.container}>
        ...
        <View style = {styles.lowerContainer} >
                         ...
                         <View style = {styles.lowerBottomContainer}>
                            ...
                            {data.map(filterData => {
                                    return(
                                        <TouchableOpacity key = {`filter-button-${filterData.id}`} style = {{
                                            height: RFValue(70),
                                            width: RFValue(70),
                                            ...
                                            borderColor: this.state.currentFilter === filterData.id ? '#ffa384' : '#fff'
                                        }} onPress = {() => this.setState({currentFilter: `${filterData.id}`})} >
                                            <Image source = {filterData.src} style = {styles.filterImage}  />
                                        </TouchableOpacity>
                                    )
                                })}
                            </ScrollView>
